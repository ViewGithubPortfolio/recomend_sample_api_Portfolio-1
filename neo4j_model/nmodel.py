...
from neo4j.exceptions import ServiceUnavailable,ClientError,AuthConfigurationError,AuthError,Forbidden
...
def buildEmbIframeTag(youtube_emb_url):
    ...
    print("build_iframe =====>>>>>>> ",iframe_tag_str)
    ...
    def build_artist_detail_and_release_disp(_result_neo4j_obj):
        ...
        for _rec in _result_neo4j_obj:
            ...
            if artist_name_trance_remove_kakko_ja != None:
                _record_d["artsitname_ja"] = artist_name_trance_remove_kakko_ja
            else:
                _record_d["artsitname_ja"] = UnitilConst.get_NA()
            ...
            '''
                dict_keys(['releaseID', 'artist_name_kakko_none', 'release_tile', 'youtube_url', 'artist_id', 'artist_name_trance_remove_kakko'])
            '''
            _relsease_res =[]
            for _release in discigs_relases:
                ...
                _relsease_inner_rec["artsitname_ja"] = _release.get("artist_name_trance_remove_kakko")
